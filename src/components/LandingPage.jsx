    ...
    <section className='overflow-hidden'>
      <nav className='bg-white flex justify-between h-[88px] border border-white items-center xl:px-32 lg:px-30 md:px-20 px-8'>
       ...
       lg:pb-0 lg:mb-12 md:pb-12 pb-12 md:pl-0 pl-9  md:opacity-100 md:bg-white bg-white   transition-all ease-in duration-500 ${
        ...
        >
          <Link to='/login'>
            <button className='border border-x-purple text-center py-3 px-4 w-[102px] h-[42px]  text-purple text-sm rounded-lg bg-white hover:bg-purple mr-4 hover:text-white '>
              LOGIN
            </button>
          </Link>
          <Link to='/signup'>
            <button className='border border-x-purple text-center py-3 px-4 w-[102px] h-[42px] text-white text-sm rounded-lg bg-purple   hover:bg-purple hover:opacity-50'>
              SIGNUP
            </button>
          </Link>
        </div>
      ...
      <div className='flex lg:flex-row md:flex-col  flex-col justify-between leading-[64px] bg-light xl:px-32 lg:px-30 md:px-20 px-10 pt-10  '>
        <div className='lg:w-1/2 md:w-full w-full '>
          <h1 className='text-black xl:text-[64px]lg:text-[60px] md:text-6xl text-5xl font-bold lg:w-[621px] md:w-full w-full lg:mt-20 '>
            Deliver a <br />{' '}
            <span className='text-purple'>Community-First </span>
            Learning Experience
          </h1>
        ...
        <div className='relative xl:ml-[400px] lg:ml-[150px] md:ml-20px ml-10 lg:mt-0 md:mt-10 mt-10 lg-w-1/2 md:w-full w-full'>
          <img
            src={PrettyLady}
            alt={PrettyLady}
            className='lg:w-full md:w-auto w-auto  lg:h-full md:h-auto h-auto'
          />
          <img
            src={Jet}
            alt={Jet}
            className='absolute top-0 left-[-35px]  lg:w-20 md:w-20 w-20'
          />
          <img
            src={Ellipse}
            alt={Ellipse}
