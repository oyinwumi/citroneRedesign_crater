        ...
        <Sidebar/>
            ...
            <div className='mt-6 w-full '>
               {beginnerCourse.map((course)=>{
                return <div className='border border-lightgrey rounded p-2 flex  lg:flex-row md:flex-row flex-col lg:items-center md:items-center justify-between w-full mb-4  ' >
                    ...
                    <Link to='/assignmentqest' className='p-2'>{button}</Link>
                </div>
               })}
            </div>
            </div>
