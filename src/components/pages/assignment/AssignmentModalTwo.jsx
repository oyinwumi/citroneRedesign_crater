...
const AssignmentModalTwo = () => {
  ...
  <div className='flex flex-col items-center'>
     <Link  to='/grade'> <button className=' text-center bg-purple text-white border rounded mb-4 p-2 w-24 hover:opacity-50'>View Grade</button></Link>
     <Link to="/editassignment"> <button className=' text-center bg-white text-purple border rounded mb-4 p-2 w-24 hover:opacity-50'>Edit</button></Link>
  </div>
</div>
</aside>
  )
