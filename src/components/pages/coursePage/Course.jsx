 ...
 const Course = () => {
  return (
    ...
    <div>
       ...
       <img src={CourseImage} alt={CourseImage}  className=" lg:w-auto md:w-auto w-[90%]"/>
       <div className="bg-pink p-4 rounded-b-lg  lg:w-auto md:w-auto w-[90%]">  
      ...
      <p className="mt-4">UI/UX DESIGN</p>
        ...
        <div className=" lg:ml-[32px] md:ml-0 ml-0 lg:mt-0 md:mt-8 mt-8">
          ...
          <li className="mb-8 ">The focus of Stutern’s UI/UX course is to expose the learner to User Interface (UI) <br /> and User Experience (UX) design.</li>
          <li className="mb-8">The focus of Stutern’s UI/UX course is to expose the learner to User Interface (UI) <br /> and User Experience (UX) design.</li>
          <li className="mb-8 ">The focus of Stutern’s UI/UX course is to expose the learner to User Interface (UI) <br /> and User Experience (UX) design.</li>
          <li className="mb-8 ">The focus of Stutern’s UI/UX course is to expose the learner to User Interface (UI) <br /> and User Experience (UX) design.</li>
          </ul>
          <button className="bg-purple text-white lg:mt-0 md:mt-10 mt-10 px-20 py-2  items-center rounded">Learn more</button>
        </div>
        </div>
       </div>
       <div className="w-full ">
