  ...
  return (
    <section  className=''>
        <nav className='bg-white flex justify-between h-[88px] border border-white items-center px-32'>
            ...
            <div>
                <button className='border border-x-purple text-center py-3 px-4 w-[102px] text-purple text-sm rounded-lg bg-white hover:bg-purple hover:text-white'>LOGIN</button>
                <button className='border border-x-purple text-center py-3 px-4 w-[102px] text-white text-sm rounded-lg bg-purple ml-3  hover:bg-purple hover:opacity-50'>SIGNUP</button>
            </div>
        </nav>
        <div className='flex justify-between items-center leading-[64px] bg-light  px-32 pt-20 '>
          <div className=''>
             <h1 className='text-black text-6xl font-bold w-[600px] mt-10'>Deliver a <span className='text-purple'>Community-First</span> Learning Experience</h1>
             <p className='text-black text-lg w-[650px] mt-8'>Citrone makes it easy for educators to create learning experiences that positively engage students.</p>
             <div className='mt-20'> 
                <button className='border border-x-purple text-center py-3 px-4 w-[184px] text-white text-sm rounded-lg bg-purple  hover:bg-purple hover:opacity-50'>Get Started for Free</button>
                <button className='border border-x-purple text-center py-3 px-4 w-[184px] ml-3 text-purple text-sm rounded-lg bg-white hover:bg-purple hover:text-white'>Learn more</button>
             </div>
          </div>
          <div className='relative mr-32'>
            ...
            <img src={Ellipse} alt={Ellipse} className='absolute bottom-2 left-[-32px]' />
          </div>
        </div>
        <section className='my-14 px-32'>
            <h2 className='text-center items-center text-purple text-2xl mb-4'>WHAT WE OFFER</h2>
            <div className='flex'>
        ...
        <section className='flex py-14 px-32 justify-between'>
           ...
           <h3 className='text-purple text-[40px] font-extrabold mb-2'>Community</h3>
            <p className='text-black font-semibold text-[32px] mb-2 '>Nurture a community-first learning experience.</p>
            <p className='text-xl'>Students who feel connected to their learning community are more likely to persist. We foster meaningful connection by ensuring students are never more than 1 click away from their peers and educators.</p>
           </div>
        </section>
        <section className='flex py-14 px-32 justify-between'>
        <div className='w-1/2 mt-20'>
           <h3 className='text-purple text-[40px] font-extrabold mb-2'>Effective Learning</h3>
            <p className='text-black font-semibold text-[32px] mb-2 '>Engaging and effective training.</p>
            <p className='text-xl'>Engage learners with video interactions, note-taking, slides, e-books, self-assessment, certificates, and much more.</p>
           </div>
        ...
        <section className='mt-32  mb-20 relative'>
           ...
           <div className='bg-light  absolute  bottom-0 w-full h-80 '>
            <h3 className='text-center text-black text-[40px] pt-12 mb-4'>Want to start learning <br /> easily today?</h3>
             <button className=' mb-16 ml-[45%] mt-6 border border-x-purple text-center py-3 px-4 w-[184px] text-white text-sm rounded-lg bg-purple  hover:bg-purple hover:opacity-50'>Get Started for Free</button> 
           </div>
        </section>
