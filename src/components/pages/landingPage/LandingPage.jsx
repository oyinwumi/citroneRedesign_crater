    ...
    <section  className='overflow-x-hidden'>
        ...
        <div className='flex lg:flex-row flex-col  md:leading-[64px] bg-light md:px-32 px-10 pt-20 '>
          <div className='md:w-1/2 w-full lg:mt-14 md:mt-0'>
             <h1 className='text-black md:text-[50px] text-[40px] font-bold md:w-[500px] w-full md:mt-10 mt-0'>Deliver a <span className='text-purple'>Community-First</span> Learning Experience</h1>
          ...
          <div className='relative lg:ml-28 md:ml-40 ml-14 md:w-1/2 w-full md:mt-0 mt-14 items-center'>
            <img src={PrettyLady} alt={PrettyLady} className='h-auto lg:w-full md:w-11/12 w-full items-center'/>
            <img src={Jet} alt={Jet}  className='absolute top-0 md:left-[-32] left-10 md:w-[80px] w-[80px]'/>
            <img src={Ellipse} alt={Ellipse} className='absolute lg:bottom-40 md:bottom-10 bottom-12 lg:left-0 md:w-[50px] w-[50px]' />
          </div>
        </div>
        ...
        <section className='flex  lg:flex-row  md:col flex-col py-14 md:px-32 px-10 justify-between mb-14'>
            <img src={MockupOne} alt={MockupOne} className=' lg:w-5/12 w-full h-auto'/>
           <div className='lg:w-1/2 md:w-full w-full md:mt-20 mt-12'>
        ...
        <section className='mt-32  mb-20 relative' >
           <div className='flex  lg:flex-row  md:flex-col flex-col px-32'>
            <img src={Mockupthree} alt={Mockupthree} className=' xl:w-6/12 lg:w-full md:w-full w-full md:h-auto h-full lg:order-1 order-2 ' />
            <p className='text-purple text-[40px] md:ml-20 ml-0  lg:order-2 order-1 lg:mb-0 mb-10'>Reporting</p>
           </div>
           <div className='bg-light  absolute xl:bottom-0 lg:bottom-0 md:-bottom-10 -bottom-10 w-full md:h-80 h-40 '>
            <h3 className='text-center text-black md:text-[40px] text-xl md:pt-12 pt-6 mb-4 '>Want to start learning <br /> easily today?</h3>
