    ...
    <div className='w-full overflow-x-auto'>
     ...
     <div className='  ml-6 w-full  border border-pink rounded p-3 mt-8 mb-14'>
       ...
       <div className='w-full  '>
        <table className='mt-7 border-collapse border border-pink rounded w-full items-center  md:text-xl text-sm 
        table-auto lg:overflow-x-auto md:overflow-x-scroll overflow-x-scroll '>
            {data.map((value)=>{
              return <tr className=' lg:text-xl border-b items-center'>
        ...
        {questions.map((question)=>{
          return <tr className=' lg:text-[16px] items-center'>
            <td className='px-4 py-2 text-start '>{question.question}</td>
