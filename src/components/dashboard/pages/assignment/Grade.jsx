        ...
        <div className='w-full px-6 '>
          ...
          <div>
            <div className='flex  flex-col mt-10 mb-4 '>
              <p className='mb-4 font-bold lg:text-[24px] md:text-xl text-xl '>
                Your Score
              </p>
              <p className='lg:text-xl'>90/100</p>
            </div>
            <div className='w-full mb-20'>
              <h5 className='font-bold lg:text-[24px] md:text-xl text-xl mb-4'>
                Tutor Remark
              </h5>
              <textarea
                name=''
                ...
                type='text'
                value='Weldone, Keep up the good work '
              ></textarea>
            </div>
          </div>
          <div className='flex justify-between  border rounded-t-lg  border-pink '>
            <div className='flex flex-col w-full '>
              ...
              <textarea
                ...
                rows='5'
                cols='8'
                className='border rounded-b-lg opacity-50  border-pink  w-full p-4 outline-none texx-lg capitalize'
              ></textarea>
            </div>
          </div>
          <div className='w-full border border-gray rounded p-2'>
            <input
              ...
              className='w-full border border-pink rounded p-2 outline-none relative '
            />
