...
const CoursePageNav = () => {
  ...
  return (
    <nav className='flex justify-between h-[104px] items-center  px-6 py-4 border-b border-lightgrey '>
      <div className=''>
        <Link to='/'>
          <img
            src={Logo}
      ...
      <div
        className={` lg:hidden px-4 md:text-center text-black  lg:z-auto md:z-50 z-50 md:absolute absolute  w-full left-0 md:w-full lg:pt-0 md:pt-10 pt-10
