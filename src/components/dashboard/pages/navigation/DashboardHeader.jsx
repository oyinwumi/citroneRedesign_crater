  ...
  return (
        <nav className='flex justify-between h-[88px] items-center  px-6 py-4 '>
         ...
         <div className=''>
          ...
          <Link
            to='/settings'
            className='text-3xl text-black lg:ml-4 md:ml-0 ml-0 lg:mt-0 md:mt-4 mt-4 cursor-pointer lg:block md:hidden hidden '>
            <FaCog />
          </Link>
          <Link
            to='/profile'
        ...
        <div className={` lg:hidden px-4 md:text-center text-black  lg:z-auto md:z-40 z-40 md:absolute absolute  w-full left-0 md:w-full lg:pt-0 md:pt-10 pt-10
     ...
     <div onClick={() => dispatch(openModalFour())} className="flex hover:bg-pink  p-4 hover:border-r-4 items-center mt-12">
