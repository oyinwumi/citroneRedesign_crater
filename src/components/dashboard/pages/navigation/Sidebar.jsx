...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`lg:mt-10 lg:border-r-2 pl-3 md:border-r-none border-r-none border-lightgrey h-full p lg:block md:hidden hidden transition-all ${
        ...
        <div className='bg-white '>
          ...
          <div
            ...
            className='flex text-xl hover:bg-pink  p-4 hover:border-r-4 items-center mt-12 cursor-pointer '>
            <img src={Logout} alt={Logout} />
            <p className={`ml-3 ${open ? 'display:block ' : 'hidden '}`}>
              Logout
            </p>
          </div>
        </div>
